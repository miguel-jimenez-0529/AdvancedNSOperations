...
*/
class LoadModelOperation: AppleOperation {
    // MARK: Properties
  ...
  init(loadHandler: @escaping (NSManagedObjectContext) -> Void) {
    ...
    override func execute() {
      ...
      let cachesFolder = try! FileManager.default.url(for: .cachesDirectory, in: .userDomainMask, appropriateFor: nil, create: true)
        ...
        let storeURL = cachesFolder.appendingPathComponent("earthquakes.sqlite", isDirectory: false)
//        .URLByAppendingPathComponent("earthquakes.sqlite")
    ...
    override func finished(errors: [NSError]) {
      ...
      alert.addAction("Retry Now") { (alertOperation : AlertOperation) in
