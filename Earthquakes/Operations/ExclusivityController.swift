...
class ExclusivityController {
  ...
  private let serialQueue = DispatchQueue(label: "Operations.ExclusivityController")
    ...
    func addOperation(operation: AppleOperation, categories: [String]) {
        /*
    ...
    func removeOperation(operation: AppleOperation, categories: [String]) {
        serialQueue.async {
            for category in categories {
    ...
    private func noqueue_addOperation(operation: AppleOperation, category: String) {
    ...
    private func noqueue_removeOperation(operation: AppleOperation, category: String) {
